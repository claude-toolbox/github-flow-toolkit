...
Install the github-flow-toolkit rules into the correct `.claude/rules/` directory.

## Steps

1. Find the plugin's `rules-templates` directory. Search in these locations (in order):
   - `~/.claude/plugins/github-flow-toolkit/rules-templates/`
   - `.claude/plugins/github-flow-toolkit/rules-templates/`
   - Any path matching `**/github-flow-toolkit/rules-templates/` under `~/.claude/`
